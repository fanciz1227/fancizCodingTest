...
public class LevelOneTest {
     ...
     */
    @Test
    public void 신규_아이디_추천() {
        StopWatch stopWatch = new StopWatch();
        stopWatch.start();

        final String answer = "bat.y.abcdefghi";
        ...
        if (length <= 2) {
            String lastStr = result.substring(length - 1);
     ...
     */
    @Test
    public void 로또의_최고_순위_최저_순위() {
        StopWatch stopWatch = new StopWatch();
        stopWatch.start();

        final int[] answer = {1, 6};
        ...
        result[0] = this.winSetData(winCnt + zeroCnt);
        result[1] = this.winSetData(winCnt);
    ...
    private int winSetData(int value) {
        int winRank = 0;
